...
public class ConfigPath {
    ...
    public static final String GENERAL_CONFIGURATION_VICTORY_ITEMS_PATH = "victory-items";
    // Replace %path% with name
    public static final String GENERAL_CONFIGURATION_VICTORY_ITEMS_MATERIAL = GENERAL_CONFIGURATION_VICTORY_ITEMS_PATH + ".%path%.material";
    public static final String GENERAL_CONFIGURATION_VICTORY_ITEMS_DATA = GENERAL_CONFIGURATION_VICTORY_ITEMS_PATH + ".%path%.data";
    public static final String GENERAL_CONFIGURATION_VICTORY_ITEMS_SLOT = GENERAL_CONFIGURATION_VICTORY_ITEMS_PATH + ".%path%.slot";
    public static final String GENERAL_CONFIGURATION_VICTORY_ITEMS_ENCHANTED = GENERAL_CONFIGURATION_VICTORY_ITEMS_PATH + ".%path%.enchanted";
    public static final String GENERAL_CONFIGURATION_VICTORY_ITEMS_COMMAND = GENERAL_CONFIGURATION_VICTORY_ITEMS_PATH + ".%path%.command";
